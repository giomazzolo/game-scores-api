...
func (gq *GameQuery) QueryScores() *ScoreQuery {
	query := (&ScoreClient{config: gq.config}).Query()
...
func (gq *GameQuery) Clone() *GameQuery {
	...
	return &GameQuery{
		...
		withScores: gq.withScores.Clone(),
...
func (gq *GameQuery) WithScores(opts ...func(*ScoreQuery)) *GameQuery {
	query := (&ScoreClient{config: gq.config}).Query()
...
func (gq *GameQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Game, error) {
	...
	if query := gq.withScores; query != nil {
		if err := gq.loadScores(ctx, query, nodes,
			func(n *Game) { n.Edges.Scores = []*Score{} },
			func(n *Game, e *Score) { n.Edges.Scores = append(n.Edges.Scores, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (gq *GameQuery) loadScores(ctx context.Context, query *ScoreQuery, nodes []*Game, init func(*Game), assign func(*Game, *Score)) error {
